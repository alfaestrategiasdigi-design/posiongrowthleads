...
BEGIN
  ...
  -- Campaign insights
  INSERT INTO public.campaign_insights (tenant_id, ad_account_id, level, campaign_id, campaign_name, date_start, spend)
  VALUES (v_tenant_a, 'act_1', 'campaign', 'cA', 'Camp A', CURRENT_DATE, 100) RETURNING id INTO v_ci_a;
  INSERT INTO public.campaign_insights (tenant_id, ad_account_id, level, campaign_id, campaign_name, date_start, spend)
  VALUES (v_tenant_b, 'act_2', 'campaign', 'cB', 'Camp B', CURRENT_DATE, 200) RETURNING id INTO v_ci_b;
