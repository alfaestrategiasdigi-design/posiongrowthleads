...
// Auth: admin (Bearer JWT) OU header x-internal-cron-secret == INTERNAL_CRON_SECRET.
...
Deno.serve(async (req) => {
  ...
  // Auth: cron header OR admin JWT
  const cronHeader = req.headers.get("x-internal-cron-secret");
