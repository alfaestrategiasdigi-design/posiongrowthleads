    ...
    <div className="p-4 md:p-6 space-y-4">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 mb-4">
          ...
          <PipelineKPI icon={Sparkles} label="Conversão" value={`${agency.convRate.toFixed(1)}%`} tint="violet" />
        </div>
      ...
      <section>
        <SectionTitle icon={BarChart3} title="Gráficos e rankings detalhados" subtitle="Mesmo período selecionado acima" />
        {relatorioQuery.isLoading && (
          <div className="premium-card rounded-xl p-10 flex items-center justify-center">
            <Loader2 className="w-5 h-5 animate-spin text-amber-400" />
          </div>
